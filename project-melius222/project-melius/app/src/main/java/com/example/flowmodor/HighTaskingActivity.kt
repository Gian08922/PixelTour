...
class HighTaskingActivity : AppCompatActivity() {
    ...
    private var workTime: Long = 5400000 // 25 minutos en milisegundos
    private var restTime: Long = 1800000 // 5 minutos en milisegundos
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_high_tasking)
        ...
        botSalir.setOnClickListener{
            ...
            else
            {
                if(numRonda > 1)
                {
                    ...
                    intentCuestionarioActivity.putExtra("metodo", 2)
        ...
        timer = object : CountDownTimer(tiempo, 1000) {
            ...
            override fun onFinish() {
                ...
                if (isRestTime) {
                    ...
                    tituloCambio.text = "HIGH TASKING"
